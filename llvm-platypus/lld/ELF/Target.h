...
public:
  ...
  virtual void writeFakePltHeader(uint8_t *buf) const {}

  virtual void writePlt(uint8_t *buf, const Symbol &sym,
                        uint64_t pltEntryAddr) const {}

  virtual void writeFakePlt(uint8_t *buf, const Symbol &sym,
    uint64_t fakepltEntryAddr) const {}
  ...
  RelType customRel = 0;
  RelType ormaskRel = 0;
  RelType andmaskRel = 0;
  RelType callbackRel = 0;
  RelType callbackmaybeRel = 0;
  RelType dsobaseRel = 0;
