...
void force_lemao(void) __attribute__((used, visibility("default")));
void force_lemao(void) { placeholder1(); placeholder2(); placeholder3(); placeholder4(); placeholder5(); placeholder6(); placeholder7(); placeholder8(); placeholder9(); placeholder10(); }
