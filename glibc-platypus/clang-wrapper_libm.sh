...
MYPASS="-O2 -g -fcf-protection=full -fPIC -include masks_libm.h -fpass-plugin=${ROOT_DIR}/llvm-passes/BitMasks/build/libBitmask.so -fuse-ld=lld -Wl,--allow-shlib-undefined -Wl,-z,relro,-z,now"
